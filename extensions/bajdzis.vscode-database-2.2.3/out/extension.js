...
/******/ 			var chunk = require("./" + chunkId + ".extension.js");
...
(function () {
    ...
    if (true) {
        if ( true && module.exports) {
            module.exports = defineExtended(__webpack_require__(15));
...
module.exports = __webpack_require__(2)()
    ...
    .register("LINE_BREAK", __webpack_require__(23).EOL)
...
(function () {
    ...
    if (true) {
        if ( true && module.exports) {
            module.exports = defineIsa(__webpack_require__(2));
...
(function () {
    ...
    if (true) {
        if ( true && module.exports) {
            module.exports = defineArray(__webpack_require__(2), __webpack_require__(4), __webpack_require__(20));
        }
    } else {}
...
var extended = __webpack_require__(3),
    ...
    ParserStream = __webpack_require__(24);
...
(function () {
    ...
    if (true) {
        if ( true && module.exports) {
            module.exports = defineExtender(__webpack_require__(17));
...
(function () {
    ...
    if (true) {
        if ( true && module.exports) {
            module.exports = defineObject(__webpack_require__(2), __webpack_require__(4), __webpack_require__(6));
...
(function () {
    ...
    if (true) {
        if ( true && module.exports) {
            module.exports = defineArgumentsExtended(__webpack_require__(2), __webpack_require__(4));
...
(function () {
    ...
    if (true) {
        if ( true && module.exports) {
            module.exports = defineString(__webpack_require__(2), __webpack_require__(4), __webpack_require__(22), __webpack_require__(6));
...
(function () {
    ...
    if (true) {
        if ( true && module.exports) {
            module.exports = defineDate(__webpack_require__(2), __webpack_require__(4), __webpack_require__(6));
...
var extended = __webpack_require__(3),
    ...
    EMPTY = /^\s*(?:''|"")?\s*(?:,\s*(?:''|"")?\s*)*$/,
    DEFAULT_DELIMITER = ",",
    createParser = __webpack_require__(25),
    fs = __webpack_require__(1),
...
var fs = __webpack_require__(1),
    ...
    CsvTransformStream = __webpack_require__(27);
...
var fs = __webpack_require__(1),
    ...
    LINE_BREAK = extended.LINE_BREAK,
    formatter = __webpack_require__(28),
...
__webpack_require__.d(__webpack_exports__, "deactivate", function() { return /* binding */ deactivate; });
...
function getBuildQueryDocument() {
    ...
    const pathTempFile = external_vscode_["workspace"].rootPath + '/.vscode/temp.sql';
    const pathLastSQLFile = external_vscode_["workspace"].rootPath + '/.vscode/last.sql';
...
const showWebview = (viewName, title) => {
    return new Promise((resolve, reject) => {
        external_fs_["readFile"](getPath(['views', `${viewName}.html`]), 'utf8', (err, html) => {
            ...
            const cssUri = panel.webview.asWebviewUri(external_vscode_["Uri"].file(getPath(['style.css'])));
...
const allServerType = {
    mysql: () => Promise.all(/* import() */[__webpack_require__.e(0), __webpack_require__.e(5)]).then(__webpack_require__.bind(null, 56)),
    mysqlssl: () => Promise.all(/* import() */[__webpack_require__.e(0), __webpack_require__.e(3)]).then(__webpack_require__.bind(null, 153)),
    postgres: () => Promise.all(/* import() */[__webpack_require__.e(1), __webpack_require__.e(6)]).then(__webpack_require__.bind(null, 71)),
    postgresSSL: () => Promise.all(/* import() */[__webpack_require__.e(1), __webpack_require__.e(4)]).then(__webpack_require__.bind(null, 154)),
};
const factoryServer = (type) => __awaiter(void 0, void 0, void 0, function* () {
    if (allServerType[type]) {
        const serverModule = yield allServerType[type]();
...
var extension_connectToSQLServer_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
class extension_connectToSQLServer_ConnectToSQLServer extends AbstractAction {
    constructor() {
        super(...arguments);
        this.dataFormCache = null;
    }
    getDataForm() {
        return extension_connectToSQLServer_awaiter(this, void 0, void 0, function* () {
            if (this.dataFormCache !== null) {
                return this.dataFormCache;
            }
            // TODO move fieldsToConnect to other file without lazy loading
            const loadAllType = Object.keys(allServerType).map((key) => extension_connectToSQLServer_awaiter(this, void 0, void 0, function* () {
                const serverModule = yield allServerType[key]();
                return {
                    type: key,
            ...
            const dataForm = yield Promise.all(loadAllType);
...
const asciiTableBig = (json, appendLine) => {
    let widthKey = 0;
    let widthData = 0;
...
const asciiTable = (json, appendLine) => {
    const MAX_CHARACTERS_IN_LINE = 180;
    const keys = Object.keys(json[0]);
    const width = {};
    const line = function () {
...
var fast_csv = __webpack_require__(10);
...
class Manager_Manager {
    ...
    connectPromise(type, fields) {
        return Manager_awaiter(this, void 0, void 0, function* () {
            const newServer = yield factoryServer(type);
            const _this = this;
    ...
    restoreConnections(databases) {
        return databases.forEach((fields) => Manager_awaiter(this, void 0, void 0, function* () {
            const newServer = yield factoryServer(fields.type);
            newServer.setOutput(this.OutputChannel);
    ...
    getCompletionItem() {
        ...
        for (const tableName in databaseScructure) {
            ...
            for (const columnName in databaseScructure[tableName]) {
                ...
                const item = new external_vscode_["CompletionItem"](tableName + '.' + element.Field);
