...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MySQLSSLType", function() { return MySQLSSLType; });
...
/* harmony import */ var _mysql_pass__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(56);



class MySQLSSLType extends _mysql_pass__WEBPACK_IMPORTED_MODULE_2__["MySQLType"] {
    constructor() {
        super();
        this.ca = '';
        this.key = '';
    ...
    connectPromise({ host, username, password, socket, key, cert, ca }) {
        ...
        const setting = {
            ...
            ssl: {
                ...
                ca: fs__WEBPACK_IMPORTED_MODULE_0__["readFileSync"](ca).toString(),
                key: fs__WEBPACK_IMPORTED_MODULE_0__["readFileSync"](key).toString(),
                cert: fs__WEBPACK_IMPORTED_MODULE_0__["readFileSync"](cert).toString(),
            }
        };
        if (socket) {
        ...
        const connection = Object(mysql__WEBPACK_IMPORTED_MODULE_1__["createConnection"])(setting);
...
/* harmony default export */ __webpack_exports__["default"] = (MySQLSSLType);
